...
def MarvellouClassifier(DataPath):
    ...
    #----------------------------------------------------------------
    # Step 11: Display the confusion Martix
    #----------------------------------------------------------------
    print(border)
    print("Step 11: Display the confusion Martix")
    print(border) 
    ...
    #----------------------------------------------------------------
    # Step 12: Display the classificagtion report
    #----------------------------------------------------------------
    print(border)
    print("Step  12: Display the classificagtion report")
    print(border) 
