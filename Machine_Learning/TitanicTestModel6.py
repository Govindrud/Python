...
def PreserveModel(model,filename):
    ...
    print("Model preserved successfully with name :")
     
#-------------------------------------------------------------------------------
# Function name : TrainTitanicModel
# Description : It does split(X,Y).trainig
# Parameters : df
# Return : None
# Date : 14/03/2026
# Author : Govind Anil Rudrawar
...
def TrainTitanicModel(df):
    ...
    print("Coeffieceint of Model:")
    for features , coeffieicent in zip(X.columns , model.coef_[0]):
        print(features," + ",coeffieicent)
